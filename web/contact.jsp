<%-- 
    Document   : contact
    Created on : Sep 25, 2019, 11:24:51 AM
    Author     : Thien Phuc
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">.gm-style .gm-style-mtc label,.gm-style .gm-style-mtc div{font-weight:400}</style><style type="text/css">.gm-style-pbc{transition:opacity ease-in-out;background-color:black;text-align:center}.gm-style-pbt{font-size:22px;color:white;font-family:Roboto,Arial,sans-serif;position:relative;margin:0;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%)}</style><link type="text/css" rel="stylesheet" href="./resource/contact/css"><style type="text/css">.gm-style .gm-style-cc span,.gm-style .gm-style-cc a,.gm-style .gm-style-mtc div{font-size:10px}</style><style type="text/css">@media print {  .gm-style .gmnoprint, .gmnoprint {    display:none  }}@media screen {  .gm-style .gmnoscreen, .gmnoscreen {    display:none  }}</style><style type="text/css">.gm-style{font-family:Roboto,Arial,sans-serif;font-size:11px;font-weight:400;text-decoration:none}.gm-style img{max-width:none}</style><script type="text/javascript" async="" src="./resource/contact/analytics.js"></script>
        ...
        <link rel="stylesheet" type="text/css" href="./resource/contact/3627058.design.v25490.css">
        <link rel="canonical" href="http://us-123sushi.simplesite.com/410908165">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script async="" src="./resource/contact/gtm.js"></script><script type="text/javascript" src="./resource/contact/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./resource/contact/frontendApp.min.js"></script>
        ...
        <style type="text/css">.fancybox-margin{margin-right:17px;}</style><script type="text/javascript" charset="UTF-8" src="./resource/contact/common.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/map.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/util.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/marker.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/infowindow.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/onion.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/ViewportInfoService.GetViewportInfo"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/stats.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/controls.js"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/vt"></script><script type="text/javascript" charset="UTF-8" src="./resource/contact/AuthenticationService.Authenticate"></script></head>
                ...
                <div class="container">
                    <div class="title-wrapper">
                        <div class="title-wrapper-inner">
                            <a rel="nofollow" class="logo " href="/P0013Sushi">
                        ...
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper map-page">
                                ...
                                <div class="content">
                                            ...
                                            <div class="row-fluid map-page-info">
                                                ...
                                                <div class="span6">
                                                    <div class="item">
                                                        ...
                                                        <div class="content">
                                                            <p>
                                                                Monday ${requestScope.MONDAY}
                                                                <br>Tuesday ${requestScope.TUESDAY}
                                                                <br>Wednesday ${requestScope.WEDNESDAY}
                                                                <br>Thursday ${requestScope.THURSDAY}
                                                                <br>Friday ${requestScope.FRIDAY}
                                                                <br>Saturday ${requestScope.SATURDAY}
                                                                <br>Sunday ${requestScope.SUNDAY}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <img width="600" src="./resource/contact/${requestScope.CONTACT.image}"/>
                                        </div>
                                    </div>
                                </div>
